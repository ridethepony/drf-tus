...
# The suffix of local_file filenames.
source_suffix = '.rst'

# The encoding of local_file files.
...
version = rest_framework_tus.__version__
# The full version, including alpha/beta/rc tags.
release = rest_framework_tus.__version__
...
# List of patterns, relative to local_file directory, that match files and
# directories to ignore when looking for local_file files.
